...
SoundManager::SoundManager()
{
	...
	m_FallInFire.setBuffer(m_FallInFireBuffer);
	m_FallInWater.setBuffer(m_FallInWaterBuffer);
...
void SoundManager::onPlayerFallInFire()
{
	m_FallInFire.setRelativeToListener(true);
	m_FallInFire.play();
}

void SoundManager::onPlayerFallInWater()
{
	m_FallInWater.setRelativeToListener(true);
	m_FallInWater.play();
}